...
<div class="matrix-wrap">
    ...
    <div
        class="matrix-grid"
        style="grid-template-columns: 160px repeat({matrixData.dimensions
            .length}, 1fr) 60px;"
    >
        ...
        {/each}
        <div class="hdr-cell scored-hdr" title="Number of scored stories">
            Scored
        </div>
    </div>
    ...
    {#each matrixData.platforms as p}
        ...
        >
            ...
            <div class="platform-cell">
                ...
                <span class="platform-name" title={p.platform_name}
            ...
            {#each matrixData.dimensions as dim}
                ...
                <div
                    class="score-cell"
                    style="background:{cellBg(score)};border-color:{cellBorder(
                        score,
