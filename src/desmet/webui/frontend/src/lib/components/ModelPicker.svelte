    ...
    {#if isOpen}
        <div class="dropdown">
            {#if !Object.keys(models).length}
                <div class="empty-msg">
                    No providers configured. Set an API key (OPENAI_API_KEY,
                    ANTHROPIC_API_KEY, OPENROUTER_API_KEY, or GOOGLE_API_KEY) to
                    see available models.
                </div>
            {:else if !hasAnyMatches}
                <div class="empty-msg">
                    No models match "{inputValue}". Press Enter to use this as a
                    custom model.
                </div>
            {:else}
